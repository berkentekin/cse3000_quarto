...
```{r}
p <- prep_plot(filtered_data |> filter(snr=="n4"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="n2"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="0"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")


p <- prep_plot(filtered_data |> filter(snr=="2"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="4"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="6"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="8"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data |> filter(snr=="n2"), stoi_score, sim_wcr)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")
p <- prep_plot(filtered_data %snr% "n2", stoi_score, sim_editdist)
p + geom_point() + labs(x="STOI Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data %snr% "n2" |> noq(), siib_score, sim_wcr)
p + geom_point() + labs(x="SIIB Score", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data %snr% "n2" |> noq(), siib_score_gaussian, sim_wcr)
p + geom_point() + labs(x="SIIB Score (Gaussian)", y="Subjective Score (WCR)", color="SNR")

p <- prep_plot(filtered_data %snr% "n2" |> noq(), MIKNNScore2x, sim_wcr)
p + geom_point() + labs(x="MIKNN Score", y="Subjective Score (WCR)", color="SNR")
